...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/App/FamBankV_1.0.exe

dist/V3/App/FamBankV_1.0.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/App
	arm-brcm-linux-gnueabi-g++ -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}" -o dist/V3/App/FamBankV_1.0  ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/start.o: start.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/start.o start.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} dist/V3/App/FamBankV_1.0.exe
